...
<div class="contenedor">
  <div class="row">
    ...
    <div class="container">
    <card class="card2" title="Recuperacion de codigo especia de acceso">
      ...
      <label for="exampleFormControlCode" class="sr-only">Clave</label>
      <input type="password" id="inputUser" class="form-control text-dark" placeholder="Ingrese su clave" minlength="8" maxlength="12" v-model="recovery.password" required autocomplete="off"/>

      <button class="btn btn-lg btn-outline-dark btn-block" type="submit" v-if="loader2">Recuperar Codigo</button>
